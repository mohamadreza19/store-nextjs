import { User } from "@/app/admin/interfaces";
...
function AdvancedLayout1(props: Props) {
  return (
    <>
      {/* <Modal1 toggleFn={props.toggleCreateUser} /> */}
      <InfiniteScroll
        dataLength={props.uesrs.length} //This is important field to render the next data
          ...
          <div className="flex items-center gap-2 pb-4 bg-white dark:bg-gray-900">
            <div className=" relative mt-1">
              ...
              <input
                ...
                placeholder="جستجوی در نام کاربران"
              />
            </div>
...
export default AdvancedLayout1;
