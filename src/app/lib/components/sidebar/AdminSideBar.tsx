...
class AdminSideBar extends React.Component<SideBarProps, SideBarState> {
  ...
  render() {
    return (
      <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-zinc-50 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
          <Image
            width={40}
            height={40}
            className="w-auto h-6 sm:h-7"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9h2q9GjyuRUwR9Ap7yZ_eqV705W0Q016BOlLH-SPYDA&s"
            alt=""
          />
        </a>
