import { CreateProductFormikValues } from "@/app/admin/interfaces";
import {
  Formik,
  Form,
  Field,
...
const validationSchema = Yup.object().shape({
  ...
  file: Yup.mixed()
    ...
    .test("fileType", "فرمت فایل باید PDF یا تصویر باشد", (value) => {
...
interface Form1Props {
  handleFormSubmit: (values: CreateProductFormikValues) => void;
  onClose: () => void;
}
